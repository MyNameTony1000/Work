...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки(сколько нужно)		 
		'app/libs/bootstrap-4.3.1/dist/js/bootstrap.bundle.js', // Берем jQuery
		'app/libs/bootstrap-4.3.1/dist/js/bootstrap.js',
		])
